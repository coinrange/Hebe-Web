...
======================================*/
    ...
    // 3.Countdown timer 
        ...
        function makeTimer() {
                ...
                $("#days").html(days + '<span class="camp">天</span>');
                $("#hours").html(hours + '<span class="camp">小时</span>');
                $("#minutes").html(minutes + '<span class="camp">分钟</span>');
                $("#seconds").html(seconds + '<span class="camp">秒</span>');
