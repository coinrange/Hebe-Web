...
Reed Solomon coded this visible account number and added the prefix RANGE- to finally generate the account address;
...
RANGE Foundation: 15% (reserved to support the operation of the foundation)
...
The third stage (April 2019 ~ December 2019) formed the RANGE team, developed a new web wallet, developed the RANGE mobile client, and developed a centralized exchange.

The fourth phase (after January 2020) will focus on the underlying rewrite of the RANGE network, improve the efficiency of the RANGE network, further technological innovations in the RANGE SDK and mobile clients, and developer participation
